package com.bank.bian.contactcenteroperation.model;
...
/**
 * The BIAN control record for this service domain: "Contact Center Session Operating Session".
 *
 ...
 * to its asset type (Contact Center Session). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Contact Center Session Operating Session";
